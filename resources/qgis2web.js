...
map.getView().fit([-10375031.016926, 5614222.945569, -10374232.503625, 5614757.220534], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">TTC_TreeInventory4 (QFieldCloud)</h2>';
        return titleElement;
    })(),
